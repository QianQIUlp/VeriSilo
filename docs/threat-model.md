...
| ------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| Manifest traversal, package substitution or downgrade   | Strict schema, canonical package root, exact executable/file hashes, CMS detached signature, signer pin, version lock, update receipt, rollback and emergency disable | Current source-bound release input, pin rotation/revocation, and clean Windows runtime acceptance                                                                        |
