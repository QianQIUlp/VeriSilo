...
RECIPE_REL = Path("apps/camoufox-host/build/r1-formal-v1")
...
def _validate_recipe_and_mode(lock: dict) -> None:
    ...
    if (
        ...
        != "verisilo-camoufox-152.0.4-beta.28-r1-formal-v1"
    ...
    if recipe.get("name") != "camoufox-152.0.4-beta.28-r1-formal-v1":
...
def _validate_patch_contract(lock: dict) -> None:
    ...
    if incremental is not None and (
        ...
        or [item.get("id") for item in incremental] != ["0003", "0003a", "0004", "0005"]
